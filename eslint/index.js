...
const ymlPlugin = yml;
const ymlRecommended = yml.configs.recommended;
const ymlRecommendedRules = {};
for (const { rules } of ymlRecommended) {
    if (!rules) {
        continue;
    }
    for (const [ruleName, ruleConfig] of Object.entries(rules)) {
        if (ruleConfig !== undefined) {
            ymlRecommendedRules[ruleName] = ruleConfig;
        }
    }
}
const yamlEslintParser = yamlParser;
