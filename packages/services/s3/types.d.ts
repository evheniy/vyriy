import type { DeleteObjectCommandInput, GetObjectCommandInput, HeadObjectCommandInput, PutObjectCommandInput } from '@aws-sdk/client-s3';
...
export type Remove = (bucketName: string, path: string, options?: Omit<DeleteObjectCommandInput, 'Bucket' | 'Key'>) => Promise<void>;
