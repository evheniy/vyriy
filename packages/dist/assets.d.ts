...
export declare const copyCommonJsAssets: (packageDirectory: string) => Promise<void>;
export declare const copyPackageAssets: (packageDirectory: string) => Promise<void>;
