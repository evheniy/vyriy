...
export const createRawEmailBucket = (scope, id, props = {}) => new Bucket(scope, id, {
...
export const createEmailReceiving = (scope, id, props) => {
    const { domainName, emailBucket = createRawEmailBucket(scope, `${id}RawEmailBucket`, props.emailBucketProps), processor, rawEmailPrefix = 'incoming/', receiptRuleName, receiptRuleSetName, recipients, scanEnabled = true, ssmParameterNames = [], tlsPolicy = 'Require', } = props;
